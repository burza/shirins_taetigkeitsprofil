...
\HAWThesisProperties{Author={Shirin Bediako \\ MatrNr.: 2088775 \\ Sahlenburger Str. 4 \\ 22309 Hamburg \\ shirin.bediako@haw-hamburg.de}
                    ,Title={Sozial-emotionale Kompetenzen durch Spiel und Bewegung fördern}
                    ,SubTitle={Welche Chancen bieten Spiel und Bewegung für die Entwicklung von soziale-emotionalen Kompetenzen?}
                    ,EnglishTitle={Inklusive Frühpädagogik Deutschland zwischen Inklusion und Integration}
                    ,ThesisType={Hausarbeit}
                    ,ExaminationType={Einführung Kompetenzentwicklung in der Kindheit}
                    ,DegreeProgramme={Bildung und Erziehung in der Kindheit}
                    ,ThesisExperts={Prof. Dr. habil. Dagmar Bergs-Winkels}
