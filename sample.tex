...
\HAWThesisProperties{Author={Shirin Bediako \\ MatrNr.: 2088775 \\ Sahlenburger Str. 4 \\ 22309 Hamburg \\ shirin.bediako@haw-hamburg.de}
                    ...
                    ,SubTitle={Was umfasst das Tätigkeitsprofil einer Kita-Leitungkraft?}
                    ,EnglishTitle={Inklusive Frühpädagogik Deutschland zwischen Inklusion und Integration}
                    ,ThesisType={Hausarbeit}
                    ,ExaminationType={Einführung Institutionsentwicklung und Management}
...
% \includepdf[pages=-, addtotoc={1,chapter,0,Interview mit Herrn Strauß,chap:anhang_1}, scale=0.90, offset=6mm -5mm]{Interview.pdf}
% 
% \includepdfset{pagecommand={\pagestyle{scrheadings}}}
